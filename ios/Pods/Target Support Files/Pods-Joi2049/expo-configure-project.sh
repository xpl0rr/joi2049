...
with_node \
  ...
  --target "/Users/dougdelaney/Code/Joi2049/ios/Pods/Target Support Files/Pods-Joi2049/ExpoModulesProvider.swift" \
  --entitlement "/Users/dougdelaney/Code/Joi2049/ios/Joi2049/Joi2049.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-document-picker" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-sharing" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
